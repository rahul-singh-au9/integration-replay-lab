...
| `invalid`     | Excessive collections, locally valid inputs above the server limit, malformed records and an oversized request; verifies no saved run was created. One session plus six rejected saves: seven planned writes.                                                                                                      |
